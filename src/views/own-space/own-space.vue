        ...
        <Card>
            ...
            <div>
                ...
                >
                    ...
                    <div>
                        <Button type="text" style="width: 100px;" @click="cancelEditUserInfor">{{ $t('cancel') }}</Button>
                        <Button type="primary" style="width: 100px;" :loading="save_loading" @click="saveEdit">{{ $t('save') }}</Button>
                    </div>
                </Form>
            </div>
        </Card>
...
export default {
    ...
    data () {
        ...
        return {
            ...
            inforValidate: {
                license: [
                    { required: true, message: this.$t('filllicense'), trigger: 'blur' }
                ]
            },
            editPasswordForm: {
                oldPass: '',
    ...
    methods: {
        ...
        saveInfoAjax () {
            ...
            userModel.edit({license: this.userForm.license}).then(result => {
